            ...
            <div class="left">
                ...
                <div class="login_hide">
                    ...
                    <p class="left4" id="left4">
                        <input type="email" autocomplete="off" onfocus="test3(this)" onblur="test4(this)" required name="email">
                        <label for="user_email"><span>이메일*</span></label>
                    </p>
                    <p class="left5" id="left5">
                        <input type="password" value="" onfocus="test5(this)" onblur="test6(this)" name="pass">
                    ...
                    <div class="left8">
                        <input type="button" class="left8_i" value="로그인">
                    </div>
                </div>
            </div>
            <script>
